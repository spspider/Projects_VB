...
File1.Left = (Form1.Width - File1.Width)

Command1.Top = (Form1.Height - File1.Height) + 1320
Command1.Left = -500
...
fi2 = fi2 + 1
Command1.Left = Math.Cos(fi2 / 200) * (-Width) + 1000
If Command1.Left > (Form1.Width - (File1.Width + Command1.Width)) Then
...
If Command1.Left > (Width - Command1.Width) - 100 Then
Timer11.Enabled = False
le4 = Command1.Left
le1 = 0
End If
...
File1.Left = Command1.Left + Command1.Width
If Command1.Left < (Form1.Width - (Command1.Width + File1.Width)) Then
Timer12.Enabled = False
le3 = 0
End If
End Sub
...
If File1.Top < ((Form1.Height - File1.Height) - 800) Then
