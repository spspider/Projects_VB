...
Op1.Top = Math.Sin(a1 / 16) * (1000 + er + Math.Rnd * 10) + 2900
Op1.Left = Math.Cos(a1 / 13) * (1000 + er + Math.Rnd * 10) + 2900

Op2.Top = Math.Sin(a1 / 15) * (1000 + er + Math.Rnd * 10) + 3900
Op2.Left = Math.Cos(a1 / 18) * (1000 + er + Math.Rnd * 10) + 3900

Op3.Top = Math.Sin(a1 / 20) * (1000 + er + Math.Rnd * 10) + 4900
Op3.Left = Math.Cos(a1 / 14) * (1000 + er + Math.Rnd * 10) + 4900

Op4.Top = Math.Sin(a1 / 15) * (1000 + Math.Rnd * 10) + 5700
Op4.Left = Math.Cos(a1 / 12) * (1000 + Math.Rnd * 10) + 5600
