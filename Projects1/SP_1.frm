...
op1T = Math.Sin(a1 / (Form3.HSP.Value + 4)) * (Form3.HSR.Value + er + Math.Rnd * 10) + Xver
op1L = Math.Cos(a1 / (Form3.HSP.Value + 1)) * (Form3.HSR.Value + er + Math.Rnd * 10) + Yver

op2T = Math.Sin(a1 / (Form3.HSP.Value + 3)) * (Form3.HSR.Value + er + Math.Rnd * 10) + (Xver + 1000)
op2L = Math.Cos(a1 / (Form3.HSP.Value + 6)) * (Form3.HSR.Value + er + Math.Rnd * 10) + (Yver + 1000)

op3T = Math.Sin(a1 / (Form3.HSP.Value + 8)) * (Form3.HSR.Value + er + Math.Rnd * 10) + (Xver + 2000)
op3L = Math.Cos(a1 / (Form3.HSP.Value + 2)) * (Form3.HSR.Value + er + Math.Rnd * 10) + (Yver + 2000)

op4T = Math.Sin(a1 / (Form3.HSP.Value + 3)) * (Form3.HSR.Value + Math.Rnd * 10) + (Xver + 2800)
op4L = Math.Cos(a1 / Form3.HSP.Value) * (Form3.HSR.Value + Math.Rnd * 10) + (Yver + 2700)
...
Function sledE()
Line (op1L, op1T)-(op3L, op3T), RGB(0, 255 - i, 355 - i)
Line (op1L, op1T)-(op2L, op2T), RGB(0, 255 - i, 355 - i)
Line (op1L, op1T)-(op4L, op4T), RGB(0, 255 - i, 355 - i)
Line (op2L, op2T)-(op3L, op3T), RGB(0, 255 - i, 355 - i)
Line (op2L, op2T)-(op4L, op4T), RGB(0, 255 - i, 355 - i)
Line (op3L, op3T)-(op4L, op4T), RGB(0, 255 - i, 355 - i)
End Function
...
Form2.Top = Math.Cos(Spr / 40) * Screen.Width / 30 + Screen.Height / 3
Form2.Command1.Top = Form2.Top / -1 + 5000
Spr = 1 + Spr
