...
v1 = v1 + 1
For a = 1 To 100
op1T = Sin(v1 / 10 + a / 10) * a * 50 + Sin(v1 / 10) * 500 + Form1.Height / 2
op1L = Cos(v1 / 10 + a / 10) * a * 50 + Cos(v1 / 10) * 500 + Form1.Width / 2
'Line (op1L, op1T)-(op2L, op2T), RGB(a * 2, a * 2, 255 - a)
Circle (op1L, op1T), Abs(Sin(a / 33)) * 150, RGB(a * 3, a * 2, 255 - a)
