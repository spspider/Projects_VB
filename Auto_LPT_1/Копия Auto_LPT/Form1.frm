...
Ns = Val(List2.Text)
List2.ListIndex = 1
For i = 0 To (Ns * 3 + 1 + Val(List2.Text) * 2)
Line Input #MyFile, tS1
If i >= Ns * 3 + 2 + Val(List2.Text) Then
List6.AddItem (tS1)
End If
Next i
Close #MyFile
...
Ns = Val(List2.Text)
List2.ListIndex = 1
For i = 0 To (Ns * 3 + 1 + Val(List2.Text) * 3)
Line Input #MyFile, tS1
If i >= Ns * 3 + 2 + Val(List2.Text) * 2 Then
List7.AddItem (tS1)
End If
Next i
Close #MyFile
...
Ns = Val(List2.Text)
List2.ListIndex = 1
For i = 0 To (Ns * 3 + 1 + Val(List2.Text) * 4)
Line Input #MyFile, tS1
If i >= Ns * 3 + 2 + Val(List2.Text) * 3 Then
List8.AddItem (tS1)
End If
Next i
Close #MyFile
...
Ns = Val(List2.Text)
List2.ListIndex = 1
For i = 0 To (Ns * 3 + 1 + Val(List2.Text) * 5)
Line Input #MyFile, tS1
If i >= Ns * 3 + 2 + Val(List2.Text) * 4 Then
List9.AddItem (tS1)
End If
Next i
Close #MyFile
...
Ns = Val(List2.Text)
List2.ListIndex = 1
For i = 0 To (Ns * 3 + 1 + Val(List2.Text) * 6)
Line Input #MyFile, tS1
If i >= Ns * 3 + 2 + Val(List2.Text) * 5 Then
List10.AddItem (tS1)
End If
Next i
Close #MyFile
...
List3.ListIndex = i
List4.ListIndex = i
BudVrem1 = Val(Mid(Text7.Text, 1, 2)) + Val(Mid(Text7.Text, 4, 2)) / 60
BudNach1 = Val(Mid(List4.Text, 1, 2)) + Val(Mid(List4.Text, 4, 2)) / 60
If BudVrem1 = BudNach1 Then
DEC1
End If
Next i
